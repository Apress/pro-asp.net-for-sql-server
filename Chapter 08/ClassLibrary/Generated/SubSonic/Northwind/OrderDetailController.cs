...
namespace Chapter08.NorthwindDAL
{
    ...
    public partial class OrderDetailController
    {
	    ...
	    public void Insert(int OrderID,int ProductID,decimal UnitPrice,short Quantity,decimal Discount)
	    {
	    ...
	    public void Update(int OrderID,int ProductID,decimal UnitPrice,short Quantity,decimal Discount)
	    {
		    OrderDetail item = new OrderDetail();
