<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AutoScaffold.aspx.cs" Inherits="AutoScaffold" ValidateRequest="false" EnableEventValidation="false" Theme="Default" MasterPageFile="~/Admin/res/MasterPage.master" Title="SubSonic AutoScaffold" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphFull" Runat="Server">
<script type="text/javascript" src="res/scripts/scaffold.js"></script>
<table style="width: 100%" id="tblWrapper" runat="server">
	<tr>
		<td style="white-space:nowrap;font-size:8pt;font-family:'Segoe UI', Verdana, Tahoma; background-color:#d3d3d3">
			...
			<a href="<%=Page.ResolveUrl("~/Admin/AutoScaffold.aspx?refresh=true")%>">Refresh Providers</a>
			</div>
			</td>
		<td style="width: 100%">
