...
<div style="width: 700px; font-size: 14px; font-family: Arial, Verdana, Sans-Serif;">
    ...
    <ol>
        <li>Use SQL Server Management Studio to create a database called Chapter03</li>
        <li>Ensure the Database project references the <code>Chapter03</code> by default</li>
