...
IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'chpt04_GetPeopleSubSetSorted')
	BEGIN
		DROP  Procedure  chpt04_GetPeopleSubSetSorted
	END

GO

CREATE Procedure dbo.chpt04_GetPeopleSubSetSorted
(
...
GRANT EXEC ON chpt04_GetPeopleSubSetSorted TO PUBLIC
GO
