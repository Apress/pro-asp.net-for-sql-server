<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" Title="Chapter 2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<div style="width: 700px; font-size: 14px; font-family: Arial, Verdana, Sans-Serif;">
    <h3>Prepare the Database:</h3>
    <ol>
        <li>Use SQL Server Management Studio to create a database called Chapter02</li>
        <li>Ensure the Database project references the <code>Chapter02</code> by default</li>
    ...
    <p>
        ...
        Change the connection string in the <code>Web.config</code> in the Website project
        and the <code>app.config</code> in the Console Application as  needed.</p>       
    <h3>Generate the Data:</h3>
    <ol>
        <li>In the <code>Solution Explorer</code> right-click the <code>ConsoleApplication</code> project and select <code>Set as Startup Project</code></li>
