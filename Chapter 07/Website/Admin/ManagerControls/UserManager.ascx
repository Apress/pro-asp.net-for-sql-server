<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UserManager.ascx.cs" Inherits="ManagedControls_UserManager" %>
<asp:Label ID="TitleLabel" runat="server" Text="User Manager"></asp:Label>&nbsp;<br />
<asp:MultiView ID="UsersMultiView" runat="server" ActiveViewIndex="0">
    <asp:View ID="SelectUserView" runat="server" OnActivate="SelectUserView_Activate">
        ...
        <td>
            <asp:GridView ID="UsersGridView" runat="server" 
                ...
                GridLines="None" AllowSorting="True" DataSourceID="ObjectDataSource1" PageSize="1">
                <Columns>
                    <asp:BoundField DataField="UserName" HeaderText="Username" SortExpression="UserName" />
                    <asp:BoundField DataField="Email" HeaderText="Email" SortExpression="Email" />
                    <asp:BoundField DataField="LastActivityDate" HeaderText="Last Activity" SortExpression="LastActivityDate" DataFormatString="{0:MM/dd/yyyy}" HtmlEncode="False" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="GetAllUsers" TypeName="MembershipHelper" EnablePaging="True" SelectCountMethod="GetUsersCount">
            <SelectParameters>
                <asp:ControlParameter ControlID="FilterUsersTextBox" Name="filter" PropertyName="Text"
                    Type="String" />
            </SelectParameters>
    ...
    <table>
        ...
        <tr>
            <td colspan="2">
                ...
                <asp:Button ID="CancelViewUserButton" runat="server" 
                    Text="Cancel" OnClick="CancelViewUserButton_Click" />
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="EmailTextBox"
                    EnableClientScript="False" ErrorMessage="*" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                </td>
        </tr>
        <tr>
            <td class="Label">
